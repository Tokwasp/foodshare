...
>
> 2~3주라는 짧은 기간 동안 **기획·개발·배포를 모두** 해내야 했습니다. 부족한 시간을 메우기 위해 AI를
> 두 곳에 자동화로 붙였습니다. 각각을 **배경 · 해결방안 · 결과**로 정리합니다.
...
빠르게 병렬로 개발하다 보니, **동료가 무엇을 어떻게 구현하고 있는지 코드를 다 읽을 수 없다**는 문제가 생겼습니다.
