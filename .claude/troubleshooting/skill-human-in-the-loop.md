...
**1. 테스트 작성 및 보고** — `docs.md` + [`test` 스킬](../skills/test)을 참고해 테스트 코드를 작성합니다.<br>
작성한 테스트를 요약해 `test.md`로 보고합니다.
...
결과적으로, 테스트를 매번 처음부터 다시 고민하지 않고 **표준 흐름으로 반복**하면서도, 명세와 테스트 덕분에 **속도와 안정성을 동시에** 확보할 수 있었습니다.
